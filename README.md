...
Velocity lets you remove the 'remote' aspect of your SPM
...
Add Velocity to your Package.swift file:

```swift
.package(url: "https://github.com/jmfieldman/Velocity.git", from: "<version>")
```
...
If you want a more streamlined execution experience, try installing Velocity 
...
# Run Velocity using Mint. This is the recommended method if you plan
